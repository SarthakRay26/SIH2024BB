...
const NavbarF = () => {
  return (
    <nav className="fixed top-0 left-1/2 transform -translate-x-1/2 w-[96vw] max-w-full bg-[#1E1E1E] p-2 z-50 rounded-3xl h-16 flex items-center mt-4 Playfair-font">
